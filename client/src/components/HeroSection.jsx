...
const HeroSection = () => {
  ...
  return (
    ...
    lg:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
      ...
      <p className='max-w-md text-gray-300'>An action-packed space adventure about a group of unlikely heroes who band together to save the galaxy from a powerful villain.
      </p>
